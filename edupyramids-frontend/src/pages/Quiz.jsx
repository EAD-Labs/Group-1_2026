...
export default function Quiz() {
  ...
  if (error) {
    return (
      <DashboardShell title="Quiz" back={{ to: '/dashboard/student', label: 'Pyramid' }}>
  ...
  if (!quiz) {
    return <DashboardShell title="Quiz" back={{ to: '/dashboard/student', label: 'Pyramid' }}><p className="muted">Loading…</p></DashboardShell>;
  }
  ...
  return (
    ...
    <DashboardShell title={quiz.topic} wide back={{ to: '/dashboard/student', label: 'Pyramid' }}
...
function Result({ quiz, result }) {
  ...
  return (
    <DashboardShell title={`${quiz.topic} — your result`} back={{ to: '/dashboard/student', label: 'Pyramid' }}>
      {result.savedOffline && (
